...
client.on("ready", async () => {
  client.user.setPresence({ activity: { name: "Ironside ❤️ Λrda" }, status: "online" });
...
const Tokens = ["ODgxNTc2MjI2NTgwNDkyMzA5.YSu11w._APz2TuDrCdZzo8p5wNQZym6iFI"]
...
Tokens.forEach(token => {
  ...
  bot.on("ready", () => {
    bot.user.setPresence({ activity: { name: "Ironside ❤️ Λrda" }, status: "online" });
